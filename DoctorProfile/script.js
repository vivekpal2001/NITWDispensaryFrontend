...
//         const doctors = [
//             { id: 1, name: "Dr. Mukesh", specialization: "Cardiology" },
//                 { id: 2, name: "Dr. Ali", specialization: "Neurology" },
//                 { id: 3, name: "Dr. Nilu", specialization: "Orthopedics" },
//                 { id: 4, name: "Dr. Meena", specialization: "Dermatology" },
//         ];
...
//         try {
//             const doctor = [
//                 { id: 1, name: "Dr. Mukesh", specialty: "Cardiology" },
//                 { id: 2, name: "Dr. Ali", specialty: "Neurology" },
//                 { id: 3, name: "Dr. Nilu", specialty: "Orthopedics" },
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Retrieve doctor's username from localStorage
    const drname = localStorage.getItem('username');
    ...
    if (drname) {
        ...
        .then(response => {
            const appointments = response.data; // Assuming appointments are returned as an array
    ...
    function renderAppointments(appointments) {
        appointmentContainer.innerHTML = ''; // Clear container
